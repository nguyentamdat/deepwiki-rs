...
Deepwiki-rs supports 9 LLM providers including OpenAI Codex OAuth, OpenAI, Anthropic, Google Gemini, Moonshot, DeepSeek, Mistral, OpenRouter, and local Ollama instances. Configuration supports dual-model setup with automatic fallback from efficient to powerful models.

**Example Code**:

```
# For OpenAI Codex OAuth (run `codex login` first)
[llm]
provider = "openai-codex"
api_key = ""
api_base_url = "https://chatgpt.com/backend-api/codex"
model_efficient = "gpt-5-codex-mini"
model_powerful = "gpt-5-codex"
